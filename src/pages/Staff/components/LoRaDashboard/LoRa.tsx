  ...
  return (
    <div className="my-12">
      ...
      <div className="flex flex-wrap w-full gap-12 justify-between">
        <button className="rounded-[6px] transition hover:bg-[#F3F4F6] flex flex-col justify-center items-center min-w-[362px] min-h-[275px] border-2 border-dashed border-gray-300 text-t4 font-medium text-black">
