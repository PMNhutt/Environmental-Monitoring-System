  ...
  return (
    <div className="border-[#B4BECF] border rounded p-2 ">
      <div
        ...
        className={`${
          selectedSensorId === sensorData.id
            ? 'bg-[#EFEDFD] border-primary '
            : 'bg-white border-[#B4BECF] hover:bg-gray-100'
        } max-w-[200px] max-h-[200px] border bg-[#EFEDFD] p-4 rounded cursor-pointer transition relative`}
      >
        <p
          className={`${
            selectedSensorId === sensorData.id ? 'text-primary' : 'text-[#424856]'
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex items-center justify-between py-2 min-w-[200px]">
          ...
          <input
            ...
            className={`block max-w-[150px] h-[36px] ${
              errors?.min ? 'mb-[5px]' : 'mb-[0px]'
